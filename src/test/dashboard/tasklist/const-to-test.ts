...
export const TASKLISTS_SHARED: any = [
  {
    id: 67,
    name: 'dasdasad',
    is_write: null,
...
export const AUTHORS: Authen[] = [
  {user_id: 2, task_list_id: 12, is_write: true, user_email: null},
  {user_id: 3, task_list_id: 12, is_write: true, user_email: null},
  {user_id: 4, task_list_id: 12, is_write: true, user_email: null},
  {user_id: 5, task_list_id: 12, is_write: null, user_email: null},
  {user_id: 6, task_list_id: 12, is_write: null, user_email: null},
  {user_id: 7, task_list_id: 12, is_write: null, user_email: null},
];
